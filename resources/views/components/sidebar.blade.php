    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @if (auth()->user()->username == "AAA")
                ...
                <li class="{{ Request::is('blank-page') ? 'active' : '' }}">
                    <a class="nav-link"
                        href="{{ url('list-tool') }}"><i class="fa-solid fa-screwdriver-wrench"></i> <span>List Tools</span></a>
                </li>
                {{-- <li class="{{ Request::is('blank-page') ? 'active' : '' }}">
                    <a class="nav-link"
                        href="{{ url('tool') }}"><i class="fa-solid fa-screwdriver-wrench"></i> <span>Tools</span></a>
                </li> --}}
            @endif
