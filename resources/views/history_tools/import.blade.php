                 ...
                 <p class="ml-3">How to import table from Excel : </p>
                    <ul class="ml-4">
                        ...
                        <div class="card">
                            <div>
                                <div class="card-body"> 
                                    <form action="{{ route('historytools.upload') }}" method="POST" enctype="multipart/form-data" style="display:inline">
                                        @csrf
                                    ...
                                    <a href="/history-tools" class="btn btn-secondary px-3 mt-3 mb-3">Cancel</a>
                                </div>
                            </div>
                        </div>
